...
<body>
    <div class="update-profile">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <a href="../html files/update_profile.php?gob=<?php echo $user_id; ?>" style="color: white;"><button class="delete-btn" ><a href="../html files/update_profile.php?gob=<?php echo $user_id; ?>" style="color: white;"><--Go Back</a></button></a>
